...
aws s3 cp bin/index_docs_editor_0_0_7_3.html s3://opt-static-resources/assets/index_docs_editor_0_0_7_3.html --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers;
