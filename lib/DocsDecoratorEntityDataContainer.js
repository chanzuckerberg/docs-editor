...
var DocsDecoratorEntityDataContainer = function (_React$PureComponent) {
  ...
  function DocsDecoratorEntityDataContainer(WrappedComponent, decoratorType, props, context) {
    ...
    _this._id = (0, _DocsHelpers.uniqueID)();
    _this._node = null;
    ...
    _this._onEntityDataChange = function (entityData) {
      ...
      var event = (0, _DocsHelpers.createDOMCustomEvent)(_DocsEventTypes2.default.EDITOR_REQUEST_UPDATE_ENTITY_DATA, true, true, detail);
  ...
  (0, _createClass3.default)(DocsDecoratorEntityDataContainer, [{
    ...
    value: function _getEditorElement() {
      return (0, _DocsHelpers.lookupElementByAttribute)((0, _DocsHelpers.asElement)(_reactDom2.default.findDOMNode(this)), _DocsDataAttributes2.default.EDITOR_FOR);
    }
  }, {
    key: '_listen',
    ...
    value: function _writeEntityData() {
      ...
      var node = (0, _DocsHelpers.asElement)(_reactDom2.default.findDOMNode(this));
      (0, _invariant2.default)(node.nodeType === 1, 'must be an element');
      this._node = node;
