...
var DocsImage = function (_React$Component) {
  ...
  function DocsImage() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocsImage.__proto__ || (0, _getPrototypeOf2.default)(DocsImage)).call.apply(_ref, [this].concat(args))), _this), _this._imageEditorModal = null, _this._imageID = (0, _DocsHelpers.uniqueID)(), _this._container = null, _this._unmounted = false, _this.state = {
      error: false,
      editing: false,
      resizeChange: null
      ...
      if (_this._container) {
        // Remove old listener.
        _ResizeObserver2.default.unobserve((0, _DocsHelpers.asElement)(_this._container));
      }
      if (ref) {
        // Register new listener.
        _this._container = (0, _DocsHelpers.asElement)(_reactDom2.default.findDOMNode(ref));
...
module.exports = (0, _docsWithContext2.default)(DocsImage);