...
function toggleIndexColumnBackground(entityData) {
  var key = TableEntityDataKeys.LEFT_COL_BG_STYLE;
...
function toggleHeaderBackground(entityData) {
  var key = TableEntityDataKeys.TOP_ROW_BG_STYLE;
  var value = !entityData[key];
...
function toggleBorders(entityData) {
  var key = TableEntityDataKeys.NO_BORDERS;
  var value = !entityData[key];
...
function togglePaddings(entityData) {
  var key = TableEntityDataKeys.PADDING_SIZE;
  var value = !entityData[key];
  return (0, _extends5.default)({}, entityData, {
...
module.exports = {
  ...
  TableEntityDataKeys: TableEntityDataKeys,
