...
var DocsMath = function (_React$PureComponent) {
  ...
  function DocsMath() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocsMath.__proto__ || (0, _getPrototypeOf2.default)(DocsMath)).call.apply(_ref, [this].concat(args))), _this), _this._id = (0, _DocsHelpers.uniqueID)(), _this._mathEditorModal = null, _this.state = {
      editing: false,
  ...
  (0, _createClass3.default)(DocsMath, [{
    ...
    value: function render() {
      ...
      var content = ready ? _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: (0, _DocsHelpers.renderLatexAsHTML)(latex || '') } }) : _react2.default.createElement(
        'span',
        null,
        '...'
      );
...
module.exports = (0, _docsWithContext2.default)(DocsMath);