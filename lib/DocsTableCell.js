...
var DocsTableCell = function (_React$PureComponent) {
  ...
  function DocsTableCell() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocsTableCell.__proto__ || (0, _getPrototypeOf2.default)(DocsTableCell)).call.apply(_ref, [this].concat(args))), _this), _this._editor = null, _this._editorID = (0, _DocsHelpers.uniqueID)(), _this._localRawContentState = null, _this._timer = new _Timer2.default(), _this.state = {
      ...
      rawContentState[_DocsTableModifiers.LOCAL_CHANGE_ID] = (0, _DocsHelpers.uniqueID)();
...
module.exports = (0, _docsWithContext2.default)(DocsTableCell);