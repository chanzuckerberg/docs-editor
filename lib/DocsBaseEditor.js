...
var babelPluginFlowReactPropTypes_proptype_EditorProps = require('./Types').babelPluginFlowReactPropTypes_proptype_EditorProps || require('prop-types').any;
...
var DocsBaseEditor = function (_React$PureComponent) {
  ...
  function DocsBaseEditor(props, context) {
    ...
    _this3._onPastedText = function (text, html) {
      ...
      if (event && editor) {
        ...
        if (clipboardData && clipboardData.isRichText() && internalClipboard) {
          ...
          var textBlocks = text ? (0, _DocsHelpers.splitTextIntoTextBlocks)(text) : [];
      ...
      var newEditorState = (0, _DocsModifiers.pasteHTML)(editorState, html || (0, _DocsHelpers.splitTextIntoTextBlocks)(text).join('<br />'));
    ...
    _this3._doFocus = function () {
      ...
      (0, _DocsHelpers.tryFocus)(_this3._editor);
    ...
    _this3._doBlur = function () {
      ...
      (0, _DocsHelpers.tryBlur)(_this3._editor);
    };

    _this3._id = props.id || (0, _DocsHelpers.uniqueID)();
  ...
  (0, _createClass3.default)(DocsBaseEditor, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.id !== this.props.id) {
        ...
        this._id = nextProps.id || (0, _DocsHelpers.uniqueID)();
...
module.exports = (0, _docsWithContext2.default)(DocsBaseEditor);