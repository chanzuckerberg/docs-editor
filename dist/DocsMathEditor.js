...
var DocsMathEditor = function (_React$PureComponent) {
  ...
  function DocsMathEditor() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocsMathEditor.__proto__ || (0, _getPrototypeOf2.default)(DocsMathEditor)).call.apply(_ref, [this].concat(args))), _this), _this._id = (0, _uniqueID2.default)(), _this._inputValue = null, _this._unmounted = false, _this.state = {
      contentHeight: 0,
      contentWidth: 0,
      showGuide: false,
      symbolsGuide: null
