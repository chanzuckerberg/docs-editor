...
var DocsTextInputEditor = function (_React$PureComponent) {
  ...
  function DocsTextInputEditor() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocsTextInputEditor.__proto__ || (0, _getPrototypeOf2.default)(DocsTextInputEditor)).call.apply(_ref, [this].concat(args))), _this), _this._id = (0, _uniqueID2.default)(), _this._timer = new _Timer2.default(), _this.state = {
