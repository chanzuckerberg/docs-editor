...
var DocsPage = function (_React$PureComponent) {
  ...
  function DocsPage() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocsPage.__proto__ || (0, _getPrototypeOf2.default)(DocsPage)).call.apply(_ref, [this].concat(args))), _this), _this._id = (0, _uniqueID2.default)(), _this.state = {
